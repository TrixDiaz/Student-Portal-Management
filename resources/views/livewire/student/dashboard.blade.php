                ...
                <div class="p-4 space-y-3">
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-200">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <div @click="$dispatch('open-modal-{{ $roomSection->id }}')" class="flex-1 flex justify-between items-center cursor-pointer">
                            ...
                            {{-- @if($grade) --}}
                            <!-- <button
                                @click="$dispatch('open-modal-{{ $roomSection->id }}')"
                        ...
                        <div x-data="{ 
                            ...
                            init() {
                                this.$watch('show', value => {
                                    if (value) {
                                        this.$nextTick(() => {
                                            // Ensure we're using the correct grade data
                            ...
                            initQuizChart(quizData) {
                                ...
                                // Render both charts
                                const quizChart = new ApexCharts(document.querySelector('#quiz-chart-{{ $roomSection->id }}'), quizOptions);
                                quizChart.render();

                                const totalChart = new ApexCharts(document.querySelector('#quiz-total-chart-{{ $roomSection->id }}'), totalSection);
                                totalChart.render();
                            },
                            initGradeChart(prelim, midterm, final) {
                                ...
                                const gradeChart = new ApexCharts(document.querySelector('#grade-chart-{{ $roomSection->id }}'), gradeOptions);
                                gradeChart.render();
                            }
                        }"
                            @open-modal-{{ $roomSection->id }}.window="show = true"
                            ...
                            <div x-show="show"
                                ...
                                <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                                    ...
                                    <div class="p-6 space-y-6">
                                        ...
                                        <div class="space-y-6">
                                            <div id="quiz-chart-{{ $roomSection->id }}"></div>
                                            <div id="quiz-total-chart-{{ $roomSection->id }}"></div>
                                        </div>

                                        <!-- Term Grades Chart -->
                                        <div>
                                            <div id="grade-chart-{{ $roomSection->id }}"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
